...
invertida = nome[::-1]
posicao_ultimo_o = invertida.find("o") + (letras_nome-posicao_primeiro_o) +1

#utilizando quebra de string
string_resto = nome[posicao_primeiro_o : letras_nome]
posicao_ultimo_o_quebra = string_resto.find("o") +1
posicao_ultimo_o_quebra_final = posicao_primeiro_o + posicao_ultimo_o_quebra +1
...
print(f"O nome.: {nome} , possui {quantidade_o} letra o, o primeiro na posicao.: {posicao_primeiro_o} e o ultimo na posicao.: {posicao_ultimo_o_quebra_final}")
print("=" *20 )
